              ...
              <div className="card" style={{ borderRadius: "8px", boxShadow: "0 4px 8px rgba(0,0,0,0.1)", marginBottom: "40px", background: "#fff" }}>
                ...
                <div className="card-body" style={{ padding: "25px" }}>
                  <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="btn" disabled={loading} style={{ background: "linear-gradient(to right, #5CA9FB 0%, #6372ff 100%)", color: "white", padding: "12px 30px", borderRadius: "25px", border: "none", fontWeight: "600", letterSpacing: "0.5px", transition: "all 0.3s ease", cursor: loading ? "not-allowed" : "pointer", opacity: loading ? "0.7" : "1" }}>
      ...
      <td style={{ padding: "15px", verticalAlign: "middle" }}>
        <span style={{
          ...
          background: complaint.status === "Resolved" ? "#2ecc71" : 
                      complaint.status === "In Treatment" ? "#2ecc71" : // Green for "In Treatment"
