...
import PatientCalendar from './patientCalendar'; // Assurez-vous d'importer les composants nécessaires
import OperationPatient from './Operation';
...
export const Navigation = () => {
  ...
  const renderContent = () => {
    switch (selectedMenu) {
      case "appointment":
        return <PatientCalendar userId={userId} />;
      case "operations":
        return <OperationPatient userId={userId} />;
      case "healthHistory":
        return <div>Health History Component Here</div>;
      case "chatbot":
        return <div>Chatbot Component Here</div>;
      case "complaints":
        return <div>Complaints Component Here</div>;
      default:
        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul className="nav navbar-nav navbar-right">
              <li>
                <a href="#" className="page-scroll" onClick={() => setSelectedMenu("emergency")}>
                  Emergency
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#" className="page-scroll" onClick={() => setSelectedMenu("healthHistory")}>
                  Health History
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#" className="page-scroll" onClick={() => setSelectedMenu("complaints")}>
                  Complaints
                </a>
              </li>
              <li>
